...
namespace Merp.Web.Site.Areas.ProjectManagement.WorkerServices
{
    public class HomeControllerWorkerServices
    {
        ...
        public IEnumerable<BalanceViewModel> GetBalanceViewModel(Guid projectId, DateTime dateFrom, DateTime dateTo, BalanceViewModel.Scale scale)
        {
            ...
            Merp.ProjectManagement.CommandStack.Model.Project[] jobOrders = null;
            jobOrders = Repository.GetSeriesById<Merp.ProjectManagement.CommandStack.Model.Project>(projectId, dates);
        ...
        {
            var jobOrder = Repository.GetById<Merp.ProjectManagement.CommandStack.Model.Project>(projectId, DateTime.Now);
