...
{
    public class OutgoingCreditNoteCommands : IDisposable
    {
        private readonly AccountancyDraftsDbContext _context;

        public OutgoingCreditNoteCommands(AccountancyDraftsDbContext context)
        {
        ...
        private void UpdateDraftLineItems(OutgoingCreditNoteDraft draft, IEnumerable<DraftLineItem> lineItems)
        {
        ...
        private void UpdateDraftPricesByVat(OutgoingCreditNoteDraft draft, IEnumerable<PriceByVat> pricesByVat)
        {
            draft.PricesByVat.Clear();
            draft.PricesByVat.AddRange(pricesByVat);
        }

        private void UpdateDraftNonTaxableItems(OutgoingCreditNoteDraft draft, IEnumerable<NonTaxableItem> nonTaxableItems)
        {
