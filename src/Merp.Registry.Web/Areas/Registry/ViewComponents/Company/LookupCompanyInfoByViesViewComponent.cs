...
{
    public class LookupCompanyInfoByViesViewComponent : ViewComponent
    {
        private static IEnumerable<ViewModel.Country> Countries;

        static LookupCompanyInfoByViesViewComponent()
        {
        ...
        public IViewComponentResult Invoke(string id = "lookup_company_info_by_vies")
        {
