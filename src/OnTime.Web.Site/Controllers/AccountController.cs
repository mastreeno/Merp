...
using OnTime.Web.Site.Models.AccountViewModels;
using OnTime.Web.Site.Services;

namespace OnTime.Web.Site.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { Email = email, Name = name, Surname = surname });
            }
        }
