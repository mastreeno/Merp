...
{
    public class RegistryPublicBoundedContextConfigurator : BoundedContextConfigurator
    {
        public RegistryPublicBoundedContextConfigurator(IConfiguration configuration, IServiceCollection services)
