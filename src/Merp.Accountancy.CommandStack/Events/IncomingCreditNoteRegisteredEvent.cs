...
namespace Merp.Accountancy.CommandStack.Events
{
    public class IncomingCreditNoteRegisteredEvent : MerpDomainEvent
    {
        ...
        public IncomingCreditNoteRegisteredEvent(Guid creditNoteId, string creditNoteNumber, DateTime creditNoteDate, string currency, decimal amount, decimal taxes, decimal totalPrice, decimal totalToPay, string description, string paymentTerms, string purchaseOrderNumber,
