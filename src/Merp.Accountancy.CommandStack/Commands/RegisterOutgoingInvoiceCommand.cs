...
namespace Merp.Accountancy.CommandStack.Commands
{
    public class RegisterOutgoingInvoiceCommand : MerpCommand
    {
        ...
        public RegisterOutgoingInvoiceCommand(Guid userId, string invoiceNumber, DateTime invoiceDate, DateTime? dueDate, string currency, decimal taxableAmount, decimal taxes, decimal totalPrice, string description, string paymentTerms, string purchaseOrderNumber,
