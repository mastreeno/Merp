...
namespace Merp.Accountancy.CommandStack.Commands
{
    public class RegisterIncomingCreditNoteCommand : MerpCommand
    {
        ...
        public RegisterIncomingCreditNoteCommand(Guid userId, string creditNoteNumber, DateTime creditNoteDate, string currency, decimal taxableAmount, decimal taxes, decimal totalPrice, string description, string paymentTerms, string purchaseOrderNumber,
