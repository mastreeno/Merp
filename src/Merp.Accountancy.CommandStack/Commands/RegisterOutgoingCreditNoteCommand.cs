...
{
    public class RegisterOutgoingCreditNoteCommand : MerpCommand
    {
        ...
        public RegisterOutgoingCreditNoteCommand(Guid userId, string creditNoteNumber, DateTime creditNoteDate, string currency, decimal taxableAmount, decimal taxes, decimal totalPrice, decimal totalToPay, string description, string paymentTerms, string purchaseOrderNumber,
