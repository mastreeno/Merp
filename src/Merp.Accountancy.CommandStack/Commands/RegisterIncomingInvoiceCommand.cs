...
namespace Merp.Accountancy.CommandStack.Commands
{
    public class RegisterIncomingInvoiceCommand : MerpCommand
    {
        ...
        public RegisterIncomingInvoiceCommand(Guid userId, string invoiceNumber, DateTime invoiceDate, DateTime? dueDate, string currency, decimal taxableAmount, decimal taxes, decimal totalPrice, decimal totalToPay, string description, string paymentTerms, string purchaseOrderNumber,
