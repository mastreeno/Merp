...
namespace Merp.Accountancy.CommandStack.Model
{
        ...
        IApplyEvent<OutgoingCreditNoteIssuedEvent>
    {
        ...
        {
            public static OutgoingCreditNote Issue(IOutgoingCreditNoteNumberGenerator generator, DateTime creditNoteDate, string currency, decimal amount, decimal taxes, decimal totalPrice, string description, string paymentTerms, string purchaseOrderNumber, Guid customerId,
