...
WORKDIR /src
COPY ["src/Merp.Registry.Web.Api.Internal/Merp.Registry.Web.Api.Internal.csproj", "src/Merp.Registry.Web.Api.Internal/"]
...
RUN dotnet restore "src/Merp.Registry.Web.Api.Internal/Merp.Registry.Web.Api.Internal.csproj"
COPY . .
WORKDIR "/src/src/Merp.Registry.Web.Api.Internal"
RUN dotnet build "Merp.Registry.Web.Api.Internal.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "Merp.Registry.Web.Api.Internal.csproj" -c Release -o /app/publish

FROM base AS final
WORKDIR /app
COPY --from=publish /app/publish .
ENTRYPOINT ["dotnet", "Merp.Registry.Web.Api.Internal.dll"]