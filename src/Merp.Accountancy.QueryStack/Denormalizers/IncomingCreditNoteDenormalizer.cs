...
{
    public class IncomingCreditNoteDenormalizer :
        IHandleMessages<IncomingCreditNoteRegisteredEvent>,
        IHandleMessages<IncomingCreditNoteLinkedToJobOrderEvent>
    {
        private DbContextOptions<AccountancyDbContext> Options;

        public IncomingCreditNoteDenormalizer(DbContextOptions<AccountancyDbContext> options)
        {
            Options = options ?? throw new ArgumentNullException(nameof(options));
        }

        public async Task Handle(IncomingCreditNoteRegisteredEvent message)
        {
            ...
            {
                ctx.IncomingCreditNotes.Add(creditNote);
