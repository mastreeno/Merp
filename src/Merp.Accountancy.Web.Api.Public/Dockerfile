...
WORKDIR /src
COPY ["src/Merp.Accountancy.Web.Api.Public/Merp.Accountancy.Web.Api.Public.csproj", "src/Merp.Accountancy.Web.Api.Public/"]
...
RUN dotnet restore "src/Merp.Accountancy.Web.Api.Public/Merp.Accountancy.Web.Api.Public.csproj"
COPY . .
WORKDIR "/src/src/Merp.Accountancy.Web.Api.Public"
RUN dotnet build "Merp.Accountancy.Web.Api.Public.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "Merp.Accountancy.Web.Api.Public.csproj" -c Release -o /app/publish

FROM base AS final
WORKDIR /app
COPY --from=publish /app/publish .
ENTRYPOINT ["dotnet", "Merp.Accountancy.Web.Api.Public.dll"]