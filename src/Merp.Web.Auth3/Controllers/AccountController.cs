...
namespace Merp.Web.Auth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly AccountControllerWorkerServices _workerServices;
        ...
        {
            var viewModel = await _workerServices.GetLogoutViewModelAsync(logoutId, User.Identity.IsAuthenticated);
        ...
        {
            var viewModel = await _workerServices.GetLoggedOutViewModelAsync(model.LogoutId, User);
