...
<script>
    import VatNumberSearch from '@/app/contexts/registry/shared/party/vatNumberSearch.vue'
    import PersonInfoAutocomplete from '@/app/contexts/registry/private/personInfoAutocomplete.vue'
