...
<script>
    ...
    export default {
        name: 'incomingInvoiceDetails',
        mixins: [EndpointConfigurationMixin],
        urls: {
            incomingInvoiceDetailsLocalization: window.endpoints.accountancy.incomingInvoiceDetailsLocalization,
            incomingInvoiceDetails: window.endpoints.accountancy.incomingInvoiceDetails
        },
        data() {
            return {
                isLoading: true,
        ...
        computed: {
            ...
            pageTitle() {
                let pageTitle = this.uiTexts.incomingInvoice
        ...
        methods: {
            ...
            loadInvoiceDetails() {
                let url = this.$urls.incomingInvoiceDetails + '/' + this.invoiceId
                let self = this
            ...
            loadResources() {
                return httpClient.get(this.$urls.incomingInvoiceDetailsLocalization)
            },
