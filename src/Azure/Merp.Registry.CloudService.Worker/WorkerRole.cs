...
namespace Merp.Registry.CloudService.Worker
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("Merp.Registry.CloudService.Worker is running");
        ...
        {
            Trace.TraceInformation("Merp.Registry.CloudService.Worker is stopping");
            ...
            Trace.TraceInformation("Merp.Registry.CloudService.Worker has stopped");
        }
