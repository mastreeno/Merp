...
{
    public partial class EditOutgoingInvoiceDraft
    {
        ...
        private async Task EditDraftAsync(IssueInvoiceForm.ViewModel draft)
        {
            try
            {
                ...
                Snackbar.Add(localizer[nameof(Resources.Pages.EditOutgoingInvoiceDraft.DraftUpdateSuccessMessage)], Severity.Success);
            }
            catch
            {
                Snackbar.Add(localizer[nameof(Resources.Pages.EditOutgoingInvoiceDraft.DraftUpdateErrorMessage)], Severity.Error);
            }
        }

        private async Task IssueOutgoingInvoiceFromDraftAsync(IssueInvoiceForm.ViewModel draft)
        {
            try
            {
                var customerBillingInfo = await PartyApi.GetPartyBillingInfoByPartyIdAsync(draft.Customer!.OriginalId);
                ...
                Snackbar.Add(localizer[nameof(Resources.Pages.EditOutgoingInvoiceDraft.InvoiceIssuedFromDraftSuccessMessage)], Severity.Success);
                NavigationManager.NavigateTo(UrlBuilder.BuildSearchInvoicesUrl());
            }
            catch
            {
                Snackbar.Add(localizer[nameof(Resources.Pages.EditOutgoingInvoiceDraft.InvoiceIssuedFromDraftErrorMessage)], Severity.Error);
            }
        }

        protected override async Task OnInitializedAsync()
        {
            var draft = await Database.OutgoingInvoiceDrafts
        ...
        private IssueInvoiceForm.ViewModel ConvertDraftToViewModel(OutgoingInvoiceDraft draft)
        {
        ...
        private IssueInvoiceCommand.InvoiceLineItem MapLineItemForIssue(Model.InvoiceLineItem lineItem)
        {
        ...
        private IssueInvoiceCommand.InvoicePriceByVat MapPriceByVatForIssue(Model.InvoicePriceByVat priceByVat)
        {
        ...
        private IssueInvoiceCommand.NonTaxableItem MapNonTaxableItemForIssue(Model.NonTaxableItem nonTaxableItem)
